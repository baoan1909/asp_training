<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm5.aspx.cs" Inherits="Lab_1.WebForm5" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br/>
            <div>
                <asp:Button ID="btnTinh" runat="server" Text="=" style="width:160px; height: 29px;" OnClick="btnTinh_Click" />
            </div>
            <br/>
            <div>
